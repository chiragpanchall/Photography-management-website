        ...
        <div class="col-12">
         ...
         <?php if(isset($_SESSION['UpMsg']) && $_SESSION['UpMsg']) { echo $_SESSION['UpMsg'];unset($_SESSION['UpMsg']); }  ?>
            <div class="card">
              ...
              <a href="index.php?page=category" class="btn gradient-blue-grey-blue white"><i class="fa fa-pencil-square-o"></i>&nbsp;   Add Category</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="index.php?page=category_action&action=delete&category_id=<?php echo $rowCategory['idEvent_Category']; ?>" class="btn btn-outline-danger mr-1"><i class="fa fa-trash"></i></a>
                                    </td>
