                            ...
                            <div class="col-12">
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Payment Date</th>
                                                        <th>Event Order idEvent Order </th>
                                                        <th>Printing Order idPrinting Order </th>
                                                        <!-- <th>User Name</th> -->
                                                        <th>Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php 
                                $i = 1;
                                $selectProduct = "SELECT * FROM `payment";
                                ...
                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rowProduct['Payment_Date']; ?></td>
                                                        <td><?php echo $rowProduct['Event_Order_idEvent_Order'] ?$rowProduct['Event_Order_idEvent_Order']:"No" ?>
                                                        </td>
                                                        <td><?php echo $rowProduct['Printing_Order_idPrinting_Order']?$rowProduct['Printing_Order_idPrinting_Order']:"No"  ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="index.php?page=payment_action&action=delete&idPayment=<?php echo $rowProduct['idPayment']; ?>"
