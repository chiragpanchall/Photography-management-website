            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title">User Block List</h4>
                    </div>
                </div>
                    ...
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php 
                                $i = 1;
                                $selectUser = "SELECT * FROM `user` WHERE `status` = 'inactive' ";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        { ?>
                                           <b style="color: green;"><?php echo ucfirst($rowUser['status']); ?></b> 
                                       <?php } else { ?>
                                       <a onclick="return confirm('Are You Sure Want To Account Inactive...???')" href="index.php?page=user_action&action=active&user_id=<?php echo $rowUser['user_id']; ?>"> <b style="color: red;"><?php echo ucfirst($rowUser['status']); ?></b></a>
                                        <?php } ?>
