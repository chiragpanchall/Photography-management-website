  ...
  <option selected>Select Product</option>
      ...
      if($n != 0){
          while($row = mysqli_fetch_array($res)){
            echo '<option value="index.php?page=Product_wise_report&id='.$row['idProduct'].'">'.$row['Product_Name'].'</option>';              
          } 
      }
      else{
    ...
    <option><a class="dropdown-item" href="#">Action2</a></option>
    <option><a class="dropdown-item" href="#">Action3</a></option> -->
            ...
            <div class="card">
              ...
              <a href="index.php?page=employee" class="btn gradient-blue-grey-blue white"><i class="fa fa-pencil-square-o"></i>&nbsp;Event Order</a>
                    ...
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title" align="center">Product-wise report</h4>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                FROM `printing_order` 
                                    ...
                                    LEFT JOIN `user` ON `printing_order`.`User_idUser` = `user`.`idUser` where  Status = 3 and printing_order_details.Print_Type_Product_idProduct_Id = '$d' ";
