         ...
         <?php //if(isset($_SESSION['UpMsg']) && $_SESSION['UpMsg']) { echo $_SESSION['UpMsg'];unset($_SESSION['UpMsg']); }  ?>
                                    ...
                                    <div class="card-header">
                                        <div class="mb-3 pull-right">
                                            <a href="index.php?page=admin" class="btn gradient-blue-grey-blue white"><i
                                                    class="icon-user"></i>&nbsp; Add Admin</a>
                                        ...
                                        <div class="card-block card-dashboard">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    <?php 
                                $i = 1;
                                $selectAdmin = "SELECT * FROM `user` where isAdmin = 1";
...
<img style="height: 50px; width: 50px; border-radius: 100px;" src="<?php echo "\Final_Project\Data\ProfilePic\\".$rowAdmin['User_Photo_Path']; ?>">
                                                        ...
                                                        <td>
                                                            <!-- <a href="index.php?page=admin&idUser=<?php //echo $rowAdmin['idUser']; ?>"
                                                                class="btn btn-outline-success mr-1"><i
                                                                    class="fa fa-pencil"></i></a> -->
                                                            
                                                            <a href="index.php?page=admin_action&action=delete&idUser=<?php echo $rowAdmin['idUser']; ?>"
