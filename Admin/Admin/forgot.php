...
if (isset($_REQUEST['submit']) && $_REQUEST['submit']!="") 
{
    ...
    if ($countEmail > 0) 
    {
        ...
        $_SESSION['ErrMsg'] = '<div class="alert alert-danger">
                            <strong>Error..!!</strong> Your Email Was Not Found...!!!!
                        </div>';
...
<head>
    ...
    <title>Forgot Password Page - Convex bootstrap 4 admin dashboard template</title>
        ...
        <div class="row full-height-vh">
            <div class="col-12 d-flex align-items-center justify-content-center gradient-aqua-marine">
                <div class="card px-4 py-2 box-shadow-2">
                    ...
                    <?php if(isset($_SESSION['ErrMsg']) && $_SESSION['ErrMsg']) { echo $_SESSION['ErrMsg'];unset($_SESSION['ErrMsg']);  } ?>
                    <div class="card-body">
                        <div class="card-block">
                            <form class="pt-2" method="post" action="">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" name="email" id="inputEmail" placeholder="Your Email Address" required>
                                </div>
