...
<head>
    ...
    <title>Login Page - [ SP Photography Admin ]</title>
                        ...
                        <div class="card-block">
                            <form method="post" action="login_action.php">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="email" class="form-control form-control-lg" id="inputEmail" name="email" value="@gmail.com" placeholder="Email Address" required email>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-lg" id="inputPass" name="password" placeholder="Password" required>
                                    </div>
                                </div>
<!-- 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="text-center col-md-12">
                                        <button type="submit" name="submit" class="btn btn-danger px-4 py-2 text-uppercase white font-small-4 box-shadow-2 border-0">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card-footer grey darken-1">
                        <div class="text-center mb-1">Forgot Password? <a href="forgot.php"><b>Reset</b></a></div>
